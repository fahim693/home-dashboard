    ...
    return (
        ...
        >
                    ...
                    <div className="tbl-title" style={{ width: '100%' }}>
                        ...
                        >
                            ...
                            <ToggleButton value="right" aria-label="right aligned">
                                <Link to='/service-table' style={{ textDecoration: 'none', color: 'rgba(0, 0, 0, 0.38)' }}>
                                    Services
                                </Link>
                            </ToggleButton>
                        </ToggleButtonGroup>
            ...
            <Modal
                ...
                modalText={numSelected > 1 ? 'Are you sure you want to delete the selected items?' : 'Are you sure you want to delete the selected item?'}
            />
            <AddNewModal
                open={addNewOpen}
